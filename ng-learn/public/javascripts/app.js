...
(function() {
  var BlueCtrl, ChoiceCtrl, FlavorCtrl, PhoneCtrl, ProjectCtrl, RedCtrl, TaskCtrl, TestCtrl, ThisCtrl, TwitterCtrl, app;
  ...
  app.controller("PhoneCtrl", PhoneCtrl = (function() {
    function PhoneCtrl($scope) {
      $scope.callHome = function(message) {
        return console.log("They said: " + (message || "nothing..."));
      };
    }
  ...
  app.directive("phone", function() {
    return {
      ...
      template: "<input type='input' ng-model='value' class='form-control'>" + "<span class='hover' ng-click='dial({message:value})'>Phone home</span>"
    };
  });
